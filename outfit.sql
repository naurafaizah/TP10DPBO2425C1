...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2025 at 12:46 PM
...
(1, 'Kaos Basic Putih', 75000, 1),
(3, 'Celana Jeans', 100000, 2);
...
INSERT INTO `transaksi` (`id_transaksi`, `id_produk`, `id_pelanggan`, `jumlah`, `total_harga`) VALUES
(2, 3, 2, 1, 100000);
